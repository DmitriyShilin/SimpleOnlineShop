	...
	<body>
		...
		<div class="product-container">			
			<ul>
				...
				<li ><span class="product-price">Price: </span><span class="product-price-pc"><c:out value="${product.price}"/><c:out value="${product.currency}"/></span></li>
				...
				<li><div class="product-cart"><a href="${pageContext.request.contextPath}/buy/addToCart?idProduct=<c:out value="${product.idProduct}"/>"><img src="${pageContext.request.contextPath}/resources/images/cart.png"> Add to cart</a></div></li>
			</ul>		
		</div>				
	</body>
</html>